...
import com.basicphones.contacts.database.ContactBaseHelper;
...
public class ContactLab {
    ...
    public List<ContactInfo> getContacts()
    {
        ...
        try {
            ...
            while (!personCursor.isAfterLast()) {
                ...
                ContactInfo contact = new ContactInfo(UUID.fromString(uuid));
    ...
    public ContactInfo getContact(UUID id) {
    ...
    public File getPhotoFile(ContactInfo contact) {
