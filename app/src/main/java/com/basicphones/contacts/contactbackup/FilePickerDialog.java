...
public class FilePickerDialog extends Dialog implements AdapterView.OnItemClickListener {
    ...
    public boolean export_flag = false;
    public boolean import_flag = false;
...
//            }
        ...
        mFileListAdapter = new FileListAdapter(internalList, context, properties, export_flag);
...
//                    mFileListAdapter.notifyDataSetChanged();
    ...
    public void setExport_flag(boolean flag){
        export_flag = flag;
        if(export_flag) {
            FileListItem parent = new FileListItem();
            parent.setFilename("...");
            parent.setDirectory(true);
            parent.setLocation("/mnt/sdcard");
    ...
    public void setImport_flag(boolean flag){
        import_flag = flag;
    }
